...
public class AddPatient {
    ...
    private static final String ROOM_FILE = "C:\\Users\\91812\\Desktop\\hospital management\\Data\\rooms.txt";  
    ...
    public static void addPatient(Scanner scanner) {  
        ...
        // Get Patient ID (Check for duplicates)
        String id;
        while (true) {
        ...
        // Format data as CSV (Ensures 10 columns, date and time are split into two columns)
